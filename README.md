...
- [Restituzione del resto in monete](./Cash.c)
    - Programma che calcola il numero minimo di monete (quarter, dime, nickel, penny) da resistituire per un importo in centesimo. Utilizza funzioni modulari per ciascun tipo di monete e include validazione dell'input. 
